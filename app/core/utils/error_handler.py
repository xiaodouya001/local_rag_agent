...
class ErrorHandler:
    ...
    def classify_error(self, error: Exception) -> str:
        ...
        if "429" in str(error) or "rate limit" in error_str or "rate_limit" in error_str:
            return "rate_limit"
        elif "timeout" in error_str or "timed out" in error_str:
            return "timeout"
        elif "401" in str(error) or "unauthorized" in error_str or "invalid api key" in error_str:
            return "auth"
